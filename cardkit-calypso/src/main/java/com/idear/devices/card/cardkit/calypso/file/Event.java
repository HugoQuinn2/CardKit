...
public class Event extends File<Event> {
    ...
    public Event parse(byte[] data) {
        ...
        this.locationId           = new LocationCode(ByteUtils.extractInt(data, 7, 3, false));
        ...
        this.firstLocationId      = new LocationCode(ByteUtils.extractInt(data, 18, 3, false));
