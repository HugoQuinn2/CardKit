...
public class BitUtil {
     ...
     *            byte read
     */
    public BitUtil(final byte[] pByte) {
     ...
     */
    public BitUtil(final int pSize) {
    ...
    public Date getNextDate(final int pSize, final String pPattern, final boolean pUseBcd) {
        ...
        try {
            ...
            log.error("Parsing date error. date:" + dateTxt + " pattern:" + pPattern, e);
        }
        return date;
    }
    ...
    public String getNextHexaString(final int pSize) {
        return ByteUtils.bytesToStringNoSpace(getNextByte(pSize, true));
    }
    ...
    public void setNextHexaString(final String pValue, final int pLength) {
        setNextByte(ByteUtils.fromString(pValue), pLength);
    }
